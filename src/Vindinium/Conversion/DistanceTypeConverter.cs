...
namespace Vindinium.Conversion
{
    ...
    public class DistanceTypeConverter : TypeConverter
    {
        ...
        /// <summary>Converts a string to a Distance, using the specified
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            {
                return Distance.Parse(str, culture);
            }
        ...
        /// <summary>Converts a Distance to string, using the specified context and culture information.</summary>
        /// <param name="culture">
        ...
        /// </param>
        /// <returns>
        /// A string that represents the converted Distance.
        /// </returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            ...
            {
                return ((Distance)value).ToString(culture);
            }
